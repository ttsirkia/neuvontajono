export default {
  ...
  'queue-position-change': 'Voit tarvittaessa päivittää tietosi menettämättä sijaasi jonossa.',
  ...
  'manage-last-connection': 'Jonosta poistetun opiskelijan yhteystieto:',
  ...
  'settings-statistics-help': 'Tilastointi tallentaa tiedon, kuka on käynyt missäkin harjoitusryhmässä. Tämän tilastoinnin voi asettaa pois päältä, jolloin kaikki mahdollisesti jo kerätyt osallistujatiedot poistuvat.',
  ...
  'settings-statistics-graph-help': 'Jonotuskäyrä näkyy tästä asetuksesta riippumatta vain, mikäli käyttäjällä on oikeus nähdä vähintään toinen edellisistä tilastoista.',
  ...
  'statistics-participant-count-lead': 'Alla on esitetty tilastotietoja, kuinka monta opiskelijaa on ollut kussakin ryhmässä eri viikkoina. Tiedot kerätään automaattisesti neuvontajonon perusteella, joten tiedot eivät ole välttämättä aivan täsmällisiä, mutta niiden perusteella voit katsoa, mitkä ryhmät ovat yleensä ruuhkaisia ja mitkä väljempiä.',
  'statistics-queue-graph-lead': 'Näet jonon pituuden eri ajanhetkinä viemällä hiiren haluamasi harjoitusryhmän päälle.',
  'statistics-queue-count': 'Jonotuskerrat',
  'statistics-queue-count-lead': 'Alla on esitetty, kuinka monta kertaa kaikki opiskelijat ovat yhteensä pyytäneet neuvoja.',
  'statistics-median-queue-duration': 'Mediaaniodotusajat',
  'statistics-median-queue-duration-lead': 'Alla on esitetty, kuinka monta minuuttia jonottaminen on keskimäärin kestänyt.',
  ...
  'alert-cannot-remove-remote': 'Etäosallistujia ei voi poistaa videprojektorinäkymässä.',
