export default {
  ...
  'queue-row-short': 'Row:',
  'queue-move': 'Move',
  'queue-lead': 'In lab sessions you can ask for help from the course staff members. To make queueing fair, join the queue when you need help and wait your turn.',

  'manage-open-projector': 'Open Projector View',
  'manage-projector-help': 'Use the space key or click the participant name to remove the participant from the queue. Most browsers open a full-screen view by pressing F11.',
  ...
  'modify-date-help': 'Use formatting 2018-03-01.',
  ...
  'modify-time-help': 'Use formatting 2:15 pm or 14:15.',
  ...
  'settings-color-limits': 'Color limits for the statistics:',
  'settings-color-help': 'The first field is the limit for the yellow color and second for the red color.',
  ...
  'statistics-main': 'Statistics show how many participants there have been in the lab sessions. As the data is automatically collected, it may not be exact but should give an overview of which labs are usually crowded.',
