export default {
  ...
  'index-jumbotron-2': 'When students need help, they can join the queue. They can see their real-time position in the queue and know that course assistants help students in the order they joined the queue.',
  'index-jumbotron-3': 'Course assistants see the queue in real-time and always know who is the next student to help. Lab Session Queue also collects statistics about the number of participants in labs.',
  'index-lead': 'Use Lab Session Queue by logging in via the learning management system.',

  'queue-current-position': 'You are currently in the {position, selectordinal, one {#st} two {#nd} few {#rd} other {#th}} place.',
  ...
  'queue-multiple-languages': 'Course staff members speak multiple languages. Please select the language you would like to use.',
  ...
  'queue-group-short': 'Lab:',
  'queue-row-short': 'Row:',
  'queue-url-short': 'URL:',
  'queue-move': 'Move',
  'queue-lead': 'In lab sessions you can ask for help from the course staff members. To make queueing fair, please join the queue when you need help and wait your turn.',
  ...
  'manage-last-connection': 'Connection information for the removed participant:',
  ...
  'modify-location-help': 'If the lab is organized in the multiple locations at the same time and they share the same queue, use a comma to separate the locations.',
  ...
  'modify-remote-method-help': 'Write here the method (for example Zoom) which the students will use to participate the session.',
  ...
  'sessions-additional-info': 'More information about the lab sessions can be found <a href="{url}">here</a>.',
  'sessions-modify-link': 'You can edit the lab sessions in the <a href="{url}">course settings</a>.',
  'sessions-main-text': 'The table below lists all the lab sessions during this week. Labs with the green background are today.',
  ...
  'settings-course-url-help': 'Give a URL which contains more information about the labs. This field can be left empty.',
  ...
  'settings-statistics-help': 'This feature stores information about who has participated in which lab session. It is possible to disable this feature, and disabling it will remove all the stored data.',
  ...
  'settings-statistics-graph-help': 'Regardless of the selected option, the queue length graph will be visible only if the user is able to see either of the previous statistics.',
  ...
  'settings-actions-help': 'All lab sessions can be temporarily disabled when there is an exam period, for example. You can enable the sessions at anytime.',
  ...
  'statistics-participant-count-lead': 'Statistics show how many participants there have been in the lab sessions. As the data is automatically collected, it may not be exact but should give an overview of which labs are usually crowded.',
  'statistics-queue-graph-lead': 'You can see the graph of the queue length by hovering over the lab session you are interested of.',
  ...
  'statistics-median-queue-duration-lead': 'Statistics show how many minutes participants have been on average in the queue before getting help.',
  ...
  'time-output-format': 'h:mm a',
  'date-output-format': 'll',
  ...
  'alert-new-course-created': 'A new course is created. Check the settings for this course and define the lab sessions.',
  'alert-queue-not-in-use': 'This course does not use Lab Session Queue.',
  'alert-page-update-failed': 'Updating failed. Try to reload the page.',
  'alert-session-not-found': 'The lab session cannot be found.',
  'alert-getting-queue-failed': 'Fetching the members in the queue failed.',
  ...
  'alert-getting-sessions-failed': 'Fetching the lab sessions failed.',
  ...
  'alert-cannot-remove-remote': 'Remote participants cannot be removed in the projector mode.',
